...
class TwitterHelper {
  ...
  private $last_api_call;
    public static $TWIT = "https://twitter.com";

  function requestTokenURL() { return self::$TWIT.'/oauth/request_token'; }
  function authorizeURL() { return self::$TWIT.'/oauth/authorize'; }
  function accessTokenURL() { return self::$TWIT.'/oauth/access_token'; }
  ...
  function getRequestToken() {
    ...
    //print_r($token); echo "<br /><br />";
    $this->token = new OAuthConsumer($token['oauth_token'], $token['oauth_token_secret']);
    //print_r($this->token); echo "<br /><br />";
    return $token;
  }
