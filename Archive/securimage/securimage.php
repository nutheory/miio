...
//$Cache = new Memcache;
//$Cache->connect(CACHE_HOST,CACHE_PORT) or die ("unable to connect to cache");
...
class Securimage {
  ...
  function validate()
  {
    $code = Session::Get('securimage_code_value');
    if ( isset($code) && !empty($code) ) {
      if ( $code == strtolower(trim($this->code_entered)) ) {
