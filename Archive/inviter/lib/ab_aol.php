...
define('AolImporter_LOGINFRAME_REGEX',"/<iframe[^>]*?id=\"snsModule\"[^>]*?src=\"([^\"]*)\"/ims");
...
//		}
		...
		if (preg_match(AolImporter_LOGINFRAME_REGEX,$html,$matches)) {
...
*/
		...
		$location = $this->makeAbsolute($this->homeuri, "/AB/ABExport.aspx?command=all&format=ldif");
		$html = $this->httpGet($location);
		return abi_extract_ldif($html);
	}
