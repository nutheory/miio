Profile.ReportMember = {};

Profile.ReportMember.Init = function()
{
  DOM.Hide('right_col');
...
Profile.ReportMember.Count = function(e,obj)
{
  function disallow()
  {
...
Profile.ReportMember.FormSubmit = function()
{
  var subscription = new Ajax(Profile.ReportMember.FormReturn);
  var url = "members/submit_report/"+Profile.ID;
  var params = "isajax=1";
...
Profile.ReportMember.FormReturn = function(response)
{
