...
Profile.Groups.Init = function()
{
  ...
  if (Profile.CurrentFilter=='') DOM.SetHTML('no_users','When ' + Profile.UserName + ' joins public groups, a list of those groups will be displayed here.');
