<div id="report_response" style="display:none">
  You have succesfully reported this Group. We are looking into it.
  <br><br>
...
<table id="report_form">
  <tr>
    <td colspan=2 class="text">Please let us know why you are reporting this group:</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="reporttext" colspan=2>
      <div class="input">
        <textarea name="report_text" id="report_text" onkeyup="return Group.ReportGroup.Count(event,this,'report_count');"></textarea>
      </div>
    </td>
  </tr>
  <tr>
    <td class="submit" colspan=2>
      <input type="submit" name="cancel" id="cancel" value="Cancel" onclick="return Group.Navigate('group_timeline');">
      <input type="submit" name="report_submit" id="report_submit" value="Submit Report" onclick="return Group.ReportGroup.FormSubmit();">
    </td>
  </tr>
</table>
